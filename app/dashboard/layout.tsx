...
const links = [{ name: "Administrar Usuarios", href: "/dashboard" }].sort((a, b) =>
    ...
    <>
        ...
        <div className="px-3 py-3 lg:px-5 lg:pl-3">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center">
              <Avatar>
                <AvatarImage
                  src="https://avatars.githubusercontent.com/u/123260891?s=400&u=b726168fd3cb401c563615aa706137fff23d35f4&v=4"
                  alt="@shadcn"
                />
      ...
      <div className="flex overflow-hidden bg-white dark:bg-slate-900 pt-16">
                ...
                <ul className="space-y-2 pb-2">
                  {links.map((link) => (
                    <li key={link.href}>
                      <Link
                        href={link.href}
                        className="text-base capitalize text-gray-900   font-normal rounded-lg flex items-center p-2 hover:bg-gray-100 group dark:text-white hover:dark:bg-slate-700"
                      >
        ...
        >
          ...
          <footer className="bg-white md:flex md:items-center md:justify-between shadow rounded-lg p-4 md:p-6 xl:p-8 my-6 mx-4 print:hidden dark:bg-slate-700">
            <ul className="flex items-center flex-wrap mb-6 md:mb-0 text-gray-500 dark:text-white">
              <li>
                <a
                  href="#"
            ...
            <div className="flex sm:justify-center space-x-6 text-gray-500 dark:text-white">
          ...
          <p className="text-center text-sm  my-10 print:hidden">
